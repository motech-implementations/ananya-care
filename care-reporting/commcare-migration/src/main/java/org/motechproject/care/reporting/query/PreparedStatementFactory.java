...
public class PreparedStatementFactory {
    ...
    public void buildSQLParameters(Map<String, Object> params, String query)
            throws SQLException {
    ...
    private Map<Integer, Object> arrangeParamtersInOrder(
        ...
        for (String param : params.keySet()) {
            ...
            while (matcher.find()) {
                orderedParams.put(query.indexOf(matcher.group()), params
                        .get(param));
            }
        }
