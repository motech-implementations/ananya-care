...
public class ProviderSyncMapperTest {
    ...
    public void shouldConvertKnownDateFormats() {
        ...
        validateIfDateFormatIsAccepted("29/11/2012", new DateTime(2012, 11, 29,
                0, 0, 0).toDate());
        validateIfDateFormatIsAccepted("02/01/2012", new DateTime(2012, 1, 2,
                0, 0, 0).toDate());
    }
    ...
    public void shouldThrowExceptionIfDateFormat() {
        ...
        expectedException.expectMessage(String
                .format("Exception when setting 01/13/2012 to date"));*/
    ...
    private void validateIfDateFormatIsAccepted(final String input,
            Date expected) {
        DateContainer actualDate = providerSyncMapper.map(DateContainer.class,
