...
public class DeliveryChildForm extends Form {
    ...
    private static final long serialVersionUID = -9139428868633572109L;
    ...
    @Field
    public DateTime getDateFeed() {
        return this.dateFeed;
    }

    public void setDateFeed(DateTime dateFeed) {
