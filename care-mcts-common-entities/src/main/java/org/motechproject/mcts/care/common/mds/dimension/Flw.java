...
public class Flw implements java.io.Serializable, SelfUpdatable<Flw> {
    ...
    // TODO: @JoinTable(name="flw_group_map",
     ...
     * 
     * @Field private Set<FlwGroup> flwGroups;
     */
    @Field
    ...
    /*
     * public Set<FlwGroup> getFlwGroups() { return flwGroups; }
     * 
     * public void setFlwGroups(Set<FlwGroup> flwGroups) { this.flwGroups =
     * flwGroups; }
     */
