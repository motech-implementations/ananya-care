...
public class MdsServiceFactoryImpl implements MdsServiceFactory {
	...
	public void createEntityServiceMap() {
		...
		mapper.put(MctsPregnantMother.class,
				mctsPregnantMotherMDSService);
		mapper.put(MctsLocationErrorLog.class,
				mctsLocationErrorLogMDSService);
		...
		mapper.put(MctsPregnantMotherErrorLog.class, mctsPregnantMotherErrorLogMDSService);
		mapper.put(MctsPregnantMotherServiceUpdate.class, mctsPregnantMotherServiceUpdateMDSService);
		mapper.put(UnapprovedToDiscussForm.class,
				unapprovedToDiscussFormMDSService);
		mapper.put(UnmappedToReviewForm.class,
				unmappedToReviewFormMDSService);
		mapper.put(DontKnowForm.class, dontKnowFormMDSService);
		mapper.put(MotherCaseMctsUpdate.class,
				motherCaseMctsUpdateMDSService);
		mapper.put(HubTransaction.class, hubTransactionMDSService);
		mapper.put(CaseAlreadyClosedForm.class,
				caseAlreadyClosedFormMDSService);
		mapper.put(MctsHealthworkerErrorLog.class, mctsHealthWorkerErrorLogMDSService);
	}
