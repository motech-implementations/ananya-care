...
@Component
public class MeaslesExpiryAction implements Action {
    ...
    @Autowired
    public MeaslesExpiryAction(MeaslesService measlesService) {
        this.measlesService = measlesService;
    }
