...
public class DuplicateVaccinationAlertMigrationController {
    ...
    Logger logger = Logger
            .getLogger(DuplicateVaccinationAlertMigrationController.class);
    @Autowired
    ...
    @Autowired
    public DuplicateVaccinationAlertMigrationController(
    ...
    public void deleteDuplicateVaccinationAlerts(@PathVariable String fileName) {
        DuplicateVaccinationAlertMigration duplicateVaccinationAlertMigration = new DuplicateVaccinationAlertMigration(
                scheduleService, enrollmentAlertService, allEnrollments);
        logger.info("Starting to load Case Ids from CSV...");
        duplicateVaccinationAlertMigration
                .loadCaseIdsFromCSVAndDeleteDuplicateTasks(fileName);
    }
    ...
    public void migrateOldJobs(HttpServletRequest request,
    ...
    public void closeOldTasks(HttpServletRequest request,
            HttpServletResponse response) {
        closeOldTasks.run();
    }
}
