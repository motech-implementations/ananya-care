...
public class ChildMapper {
    ...
    public static Child map(CareCase careCase){
        ...
        return new Child(
                ...
                get_date_obj(careCase.getMeasles_date()), get_date_obj(careCase.getMeasles_booster_date()), get_date_obj(careCase.getBcg_date()), get_date_obj(careCase.getVit_a_1_date()),get_date_obj(careCase.getVit_a_2_date()),careCase.getMother_id(),
